...
namespace EnvelopeOscillator
{
    struct Envelope
    {
        ...
        {
            _secondsPerSample = 1.f / sampleRate;
        }
    ...
    private:
        ...
        float _value{0.f};
        const std::vector<float> riseFallLengths{ 0.05f, 0.1f, 0.2f, 0.3f, 0.9f, 1.3f, 3.f};
    };
}
#endif